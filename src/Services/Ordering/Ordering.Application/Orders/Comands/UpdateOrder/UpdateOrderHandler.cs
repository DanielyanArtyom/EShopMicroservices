...
public class UpdateOrderHandler(IApplicationDbContext ctx): ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
    ...
    public async Task<UpdateOrderResult> Handle(UpdateOrderCommand command, CancellationToken cancellationToken)
    {
        ...
        var order = await ctx.Orders.FindAsync([orderId], cancellationToken: cancellationToken);
